#include "SwizzleDemo.h"

SwizzleDemo::SwizzleDemo(){
...
bool SwizzleDemo::Init(__in const char* vCmdLine[], __in const int iCmdCount,
    ...
    {//texture
        ...
        GLint swizzle[] = {/*GL_RED, GL_GREEN, GL_BLUE,  */GL_ALPHA, GL_BLUE, GL_GREEN, GL_RED};
