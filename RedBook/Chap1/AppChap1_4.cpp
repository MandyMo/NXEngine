...
bool AppChap1_4::Init(const char* vCmdLine[], const int iCmdCount, const int iWidth, const int iHeight){
    ...
    {//program & shader
        m_pg = new NX::Program();
        m_pg->AddShader("./Chap1/VS1_4.glsl", GL_VERTEX_SHADER);
        m_pg->AddShader("./Chap1/FS1_4.glsl", GL_FRAGMENT_SHADER);
        m_pg->LinkProgram();
        m_pg->UseProgram();
    }
    {
...
void AppChap1_4::Render(){
    ...
    glDrawElements(GL_TRIANGLES,      3, GL_UNSIGNED_INT, (void*)16);
    glDisable(GL_BLEND);
