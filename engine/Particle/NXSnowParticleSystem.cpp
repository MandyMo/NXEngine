...
NX::SnowParticleSystem::SnowParticleSystem(const std::vector<std::string> &_TextureFileSet, const float3x2 &_ParticleBound) :ParticleSystem(_TextureFileSet, _ParticleBound) {
	/**empty*/
}
...
void NX::SnowParticleSystem::AddNewParticle() {
	int _TextureIndex            = RandIntInRange(0, GetTextureSet().size());
